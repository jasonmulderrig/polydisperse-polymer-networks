...
def main(cfg: DictConfig) -> None:
    ...
    max_gamma_clnks_frame_avrg_approx_so3 = []
    ...
    for protocol_indx in range(dfrmtn_protocol_num):
        ...
        max_gamma_clnks_frame_avrg_approx_so3.append(
    ...
    for protocol_indx in range(dfrmtn_protocol_num):
        ...
        for clnk_indx in range(clnks_num):
            ...
            for dfrmtn_step in range(np.shape(dfrmtn_arr)[0]):
                ...
                (_, _, gamma_clnk_frame_avrg_approx_so3,
                ...
                max_gamma_clnks_frame_avrg_approx_so3[protocol_indx][clnk_indx, dfrmtn_step] = (
                    np.max(gamma_clnk_frame_avrg_approx_so3)
                )
    ...
    for protocol_indx in range(dfrmtn_protocol_num):
        ...
        max_gamma_clnks_frame_avrg_approx_so3_filename = (
            filename_prefix + "-max_gamma_clnks_frame_avrg_approx_so3"
        ...
        np.save(
            max_gamma_clnks_frame_avrg_approx_so3_filename,
            max_gamma_clnks_frame_avrg_approx_so3[protocol_indx])
        np.save(
            W_clnks_frame_avrg_approx_so3_quad_filename,
