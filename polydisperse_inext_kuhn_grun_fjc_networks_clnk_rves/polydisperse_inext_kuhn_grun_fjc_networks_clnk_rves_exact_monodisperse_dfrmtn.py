...
from src.helpers.clnk_free_rotation import monodisperse_clnk_free_rot
...
def main(cfg: DictConfig) -> None:
    ...
    for chn_indx in np.ndindex(np.shape(n_clnks)):
        ...
        dw_c__dy_clnk_func_clnks[chn_indx] = (
            master_dw_c__dy_clnk_func(w_c_dist_clnks[chn_indx])
        )
        dw_c__dy_clnk_args_clnks[chn_indx] = (
            master_dw_c__dy_clnk_args_func(
                w_c_dist_clnks[chn_indx], kappa_n_clnks[chn_indx],
                zeta_n_char_clnks[chn_indx], gamma_crits_clnks[chn_indx])
        )
    ...
    for protocol_indx in range(dfrmtn_protocol_num):
        ...
        for clnk_indx in range(clnks_num):
            ...
            dw_c__dy_clnk_func_clnk = dw_c__dy_clnk_func_clnks[clnk_indx]
            dw_c__dy_clnk_args_clnk = dw_c__dy_clnk_args_clnks[clnk_indx]
            ...
            for dfrmtn_step in range(np.shape(dfrmtn_arr)[0]):
                ...
                # frame averaging model for monodisperse cross-link
                # structures
                (_, _, _, W_clnk_chns_frame_avrg_approx_so3,
                 W_clnk_y_flucts_frame_avrg_approx_so3) = clnk_frame_avrg_approx(
                    ...
                    so3_quad, n_clnk, b_clnk, X_clnk, y_clnk_init,
                ...
                (_, _, _, _, W_clnk_chns_star_free_rot,
                 W_clnk_y_flucts_star_free_rot) = monodisperse_clnk_free_rot(
                    ...
                    n_clnk, b_clnk, X_clnk, y_clnk_init, gamma_clnk_init,
                    w_c_func_clnk, w_c_args_clnk,
                    d2w_c__dy_clnk_dy_clnk_func_clnk,
                    d2w_c__dy_clnk_dy_clnk_args_clnk,
                    w_c_dfrmtn_func_clnk, w_c_dfrmtn_args_clnk)
