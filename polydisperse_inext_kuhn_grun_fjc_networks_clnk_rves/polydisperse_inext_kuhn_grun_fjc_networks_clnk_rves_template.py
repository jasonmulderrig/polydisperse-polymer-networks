...
def clnk_rves_deformation(
    ...
    for protocol_indx in range(len(dfrmtn_protocol)):
        ...
        W_clnks_free_rot.append(
            np.zeros((num_dfrmtn_steps, clnks_num)))
        W_flucts_clnks_free_rot.append(
            np.zeros((num_dfrmtn_steps, clnks_num)))
            ...
            for clnk_indx in range(clnks_num):
                ...
                if (np.all(np.equal(n_clnk, n_clnk[0])) and
                    ...
                    if monodisperse_clnk:
                        ...
                        W_flucts_clnks_free_rot[protocol_indx][dfrmtn_step, clnk_indx] = (
                            W_flucts_clnk_star
                        )
                        ...
                        W_flucts_clnks_free_rot_approx[protocol_indx][dfrmtn_step, clnk_indx] = (
                            W_flucts_clnk_star
                        )
                    ...
                    if monodisperse_clnk:
                        ...
                        W_flucts_clnks_frame_avrg_so3[protocol_indx][dfrmtn_step, clnk_indx] = (
                            W_flucts_clnk_star_frame_avrg_so3
                        )
                        ...
                        W_flucts_clnks_frame_avrg_so3_quad[protocol_indx][dfrmtn_step, clnk_indx] = (
                            W_flucts_clnk_star_frame_avrg_so3_quad
                        )
                        ...
                        W_flucts_clnks_frame_avrg_approx_so3[protocol_indx][dfrmtn_step, clnk_indx] = (
                            W_flucts_clnk_star_frame_avrg_so3
                        )
                        ...
                        W_flucts_clnks_frame_avrg_approx_so3_quad[protocol_indx][dfrmtn_step, clnk_indx] = (
                            W_flucts_clnk_star_frame_avrg_so3_quad
                        )
                ...
                # Evaluate the cross-link structure deformation
                    ...
                    y_clnk_free_rot, y_clnk_norm_free_rot, gamma_clnk_free_rot,
                     W_clnk_free_rot, W_flucts_clnk_free_rot) = (
                        clnk_free_rot_cnstrnd_mnmztn(
                            eval_W_flucts, cnstrnd_mnmztn_scope,
                            cnstrnd_mnmztn_method, rng, F, n_clnk, b, X_clnk,
                            vol_quad_clnk, omega_clnk_free_rot_init,
                    ...
                    (y_clnk_frame_avrg_so3, y_clnk_norm_frame_avrg_so3,
                     ...
                     gamma_clnk_frame_avrg_so3_quad, W_clnk_frame_avrg_so3_quad) = (
                        clnk_frame_avrg_cnstrnd_mnmztn(
                            cnstrnd_mnmztn_scope, cnstrnd_mnmztn_method, rng, F,
                            n_clnk, b, X_clnk, so3_quad, sph_quad_symmtry,
                    ...
                    W_flucts_clnk_frame_avrg_so3_quad) = (
                        W_flucts_clnk_frame_avrg(
                            ...
                            so3_quad, sph_quad_symmtry, w_c_func, w_c_args,
                            w_c_dfrmtn_func, w_c_dfrmtn_args)
                    )
                    ...
                    if not np.all(np.equal(n_clnk, n_clnk[0])):
                        ...
                        if clnk_approx:
                            (_, delta_omega_clnk_free_rot_approx,
                             ...
                             gamma_clnk_free_rot_approx, W_clnk_free_rot_approx,
    ...
    for protocol_indx in range(len(dfrmtn_protocol)):
        ...
        np.save(
            W_flucts_clnks_free_rot_filename,
            W_flucts_clnks_free_rot[protocol_indx])
        ...
        np.save(
            W_flucts_clnks_free_rot_approx_filename,
            W_flucts_clnks_free_rot_approx[protocol_indx])
        ...
        np.save(
            W_flucts_clnks_frame_avrg_so3_filename,
            W_flucts_clnks_frame_avrg_so3[protocol_indx])
        np.save(
            y_clnks_frame_avrg_so3_quad_filename,
        ...
        np.save(
            W_flucts_clnks_frame_avrg_so3_quad_filename,
            W_flucts_clnks_frame_avrg_so3_quad[protocol_indx])
        ...
        np.save(
            W_flucts_clnks_frame_avrg_approx_so3_filename,
            W_flucts_clnks_frame_avrg_approx_so3[protocol_indx])
        np.save(
            delta_y_clnks_frame_avrg_approx_so3_quad_filename,
        ...
        np.save(
            W_flucts_clnks_frame_avrg_approx_so3_quad_filename,
            W_flucts_clnks_frame_avrg_approx_so3_quad[protocol_indx])

##### This code corresponds to the 20250724A.yaml configuration file.
##### Make sure to set the deformation and topology configuration files
##### to 20250724A.yaml in the config.yaml file before running.
@hydra.main(
        version_base=None,
