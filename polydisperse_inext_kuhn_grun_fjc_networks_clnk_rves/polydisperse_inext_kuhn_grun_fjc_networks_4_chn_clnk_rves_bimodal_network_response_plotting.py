...
def main(cfg: DictConfig) -> None:
    ...
    ntwrk_linestyle = ["-.", "--", ":", "-"]
    ntwrk_color = ["tab:orange", "tab:blue", "tab:green", "tab:purple"]
    markersize = 50
    dotsize = 0.5
    markerlinewidth = 0.5
    dotlinewidth = 0.125
    ...
    sample = 0
    mono_75_75_filename_prefix = filename_str(label.workdir, "20250724", "C", sample)
    bimodal_50_100_filename_prefix = filename_str(label.workdir, "20250724", "D", sample)
    bimodal_25_125_filename_prefix = filename_str(label.workdir, "20250724", "E", sample)
    ...
    n_clnks_legend = [
        "$n_a = 75, n_b = 75$", "$n_a = 50, n_b = 100$", "$n_a = 25, n_b = 125$"
    ]
    ...
    assert np.allclose(bimodal_50_100_p, bimodal_25_125_p)
    assert np.allclose(bimodal_50_100_p, np.asarray([0.25, 0.5, 0.75, 0.9]))

    p = np.asarray([0.25, 0.5, 0.75, 0.9])
    p_legend = ["$p = 0.25$", "$p = 0.50$", "$p = 0.75$", "$p = 0.90$"]
    ...
    sigma_11_free_rot_approx_uniaxl_p_half_response_plot_fig_filename = (
        filepath + "sigma_11_free_rot_approx_uniaxl_p_half_response_plot" + ".png"
    )
    fig, ax = plt.subplots()
    ...
    ax.plot(
        ...
        linestyle=ntwrk_linestyle[0], linewidth=markerlinewidth,
        c=ntwrk_color[0], label=n_clnks_legend[0])
    p_half_bimodal_50_100_sigma_11_ntwrk_free_rot_approx_uniaxl = np.sum(
        bimodal_50_100_sigma_11_clnks_free_rot_approx_uniaxl * bimodal_50_100_p_clnks[p_half_indx][:, None],
        axis=0)
    ax.plot(
        bimodal_50_100_lmbda,
        p_half_bimodal_50_100_sigma_11_ntwrk_free_rot_approx_uniaxl,
        linestyle=ntwrk_linestyle[1], linewidth=markerlinewidth,
        c=ntwrk_color[1], label=n_clnks_legend[1])
    p_half_bimodal_25_125_sigma_11_ntwrk_free_rot_approx_uniaxl = np.sum(
        bimodal_25_125_sigma_11_clnks_free_rot_approx_uniaxl * bimodal_25_125_p_clnks[p_half_indx][:, None],
        axis=0)
    ax.plot(
        bimodal_25_125_lmbda,
        p_half_bimodal_25_125_sigma_11_ntwrk_free_rot_approx_uniaxl,
        linestyle=ntwrk_linestyle[2], linewidth=markerlinewidth,
        c=ntwrk_color[2], label=n_clnks_legend[2])
    ax.legend(fontsize=12, labelspacing=0, markerfirst=False, loc="best")
    ax.set_xlim([0.5, 8.0])
    ...
    fig.tight_layout()
    fig.savefig(sigma_11_free_rot_approx_uniaxl_p_half_response_plot_fig_filename)
    plt.close()

    sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response_plot_fig_filename = (
        filepath + "sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response_plot" + ".png"
    )
    fig, ax = plt.subplots()
    ...
    p_half_bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.sum(
        bimodal_50_100_sigma_11_clnks_frame_avrg_approx_so3_quad_uniaxl * bimodal_50_100_p_clnks[p_half_indx][:, None],
        axis=0)
    ax.plot(
        bimodal_50_100_lmbda,
    ...
    p_half_bimodal_25_125_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.sum(
        bimodal_25_125_sigma_11_clnks_frame_avrg_approx_so3_quad_uniaxl * bimodal_25_125_p_clnks[p_half_indx][:, None],
        axis=0)
    ax.plot(
        bimodal_25_125_lmbda,
    ...
    fig.tight_layout()
    fig.savefig(sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response_plot_fig_filename)
    plt.close()

    bimodal_50_100_sigma_11_free_rot_approx_response_plot_fig_filename = (
        filepath + "bimodal_50_100_sigma_11_free_rot_approx_response_plot" + ".png"
    )
    fig, ax = plt.subplots()
    for p_indx in range(np.shape(p)[0]):
        bimodal_50_100_sigma_11_ntwrk_free_rot_approx_uniaxl = np.sum(
            bimodal_50_100_sigma_11_clnks_free_rot_approx_uniaxl * bimodal_50_100_p_clnks[p_indx][:, None],
            axis=0)
        ax.plot(
            bimodal_50_100_lmbda,
    ...
    ax.set_ylabel("$\\Sigma_{11}^{FR}/\\leftparen Mk_BT/2\\rightparen$", fontsize=16)
    fig.tight_layout()
    fig.savefig(bimodal_50_100_sigma_11_free_rot_approx_response_plot_fig_filename)
    plt.close()

    bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response_plot_fig_filename = (
        filepath + "bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response_plot" + ".png"
    )
    fig, ax = plt.subplots()
    for p_indx in range(np.shape(p)[0]):
        bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.sum(
            bimodal_50_100_sigma_11_clnks_frame_avrg_approx_so3_quad_uniaxl * bimodal_50_100_p_clnks[p_indx][:, None],
            axis=0)
        ax.plot(
            bimodal_50_100_lmbda,
    ...
    ax.set_ylabel("$\\Sigma_{11}^{FA}/\\leftparen Mk_BT/2\\rightparen$", fontsize=16)
    fig.tight_layout()
    fig.savefig(bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response_plot_fig_filename)
    plt.close()
