...
def main(cfg: DictConfig) -> None:
    ...
    bimodal_50_100_lmbda_aesthetic_end = np.asarray([bimodal_50_100_lmbda[-1]+0.01, bimodal_50_100_lmbda[-1]+0.02])
    bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response_plot_fig_filename = (
        filepath + "bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response_plot"
        + ".pdf"
    )
    ...
    for p_indx in range(np.shape(p)[0]):
        bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.sum(
            ...
            axis=0)
        if p_indx == 0:
            bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl[-2] = 38.
            bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl[-1] = 38.5
            bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.concatenate(
                (bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl, np.asarray([39.5, 1.e9])))
        elif p_indx == 1:
            bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl[-1] = 43.
            bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.concatenate(
                (bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl, np.asarray([45., 1.e9])))
        else:
            bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.concatenate(
                (bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl, np.full_like(bimodal_50_100_lmbda_aesthetic_end, np.nan)))
        ax.plot(
            np.concatenate((bimodal_50_100_lmbda, bimodal_50_100_lmbda_aesthetic_end)),
            bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl,
            linestyle=ntwrk_linestyle[p_indx], linewidth=markerlinewidth,
            c=ntwrk_color[p_indx], label=p_legend[p_indx])
    ax.legend(
    ...
    lmbda = mono_75_75_lmbda.copy()

    lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response_filename = (
        filepath
        + "lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response"
        + ".csv"
    )
    lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response_filename = (
        filepath
        + "lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response"
        + ".csv"
    )
    lmbda_and_bimodal_50_100_sigma_11_free_rot_approx_response_filename = (
        filepath
        + "lmbda_and_bimodal_50_100_sigma_11_free_rot_approx_response"
        + ".csv"
    )
    lmbda_and_bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response_filename = (
        filepath
        + "lmbda_and_bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response"
        + ".csv"
    )
    
    lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response = lmbda.copy()
    lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response = lmbda.copy()
    lmbda_and_bimodal_50_100_sigma_11_free_rot_approx_response = bimodal_50_100_lmbda.copy()
    bimodal_50_100_lmbda = np.concatenate(
        (bimodal_50_100_lmbda, bimodal_50_100_lmbda_aesthetic_end))
    lmbda_and_bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response = bimodal_50_100_lmbda.copy()

    nan_mono_75_75_sigma_11_ntwrk_free_rot_approx_uniaxl = np.full_like(lmbda, np.nan)
    nan_p_half_bimodal_65_85_sigma_11_ntwrk_free_rot_approx_uniaxl = np.full_like(lmbda, np.nan)
    nan_p_half_bimodal_50_100_sigma_11_ntwrk_free_rot_approx_uniaxl = np.full_like(lmbda, np.nan)
    nan_p_half_bimodal_25_125_sigma_11_ntwrk_free_rot_approx_uniaxl = np.full_like(lmbda, np.nan)
    nan_mono_75_75_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.full_like(lmbda, np.nan)
    nan_p_half_bimodal_65_85_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.full_like(lmbda, np.nan)
    nan_p_half_bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.full_like(lmbda, np.nan)
    nan_p_half_bimodal_25_125_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.full_like(lmbda, np.nan)

    nan_mono_75_75_sigma_11_ntwrk_free_rot_approx_uniaxl[:np.shape(mono_75_75_sigma_11_ntwrk_free_rot_approx_uniaxl)[0]] = mono_75_75_sigma_11_ntwrk_free_rot_approx_uniaxl
    nan_p_half_bimodal_65_85_sigma_11_ntwrk_free_rot_approx_uniaxl[:np.shape(p_half_bimodal_65_85_sigma_11_ntwrk_free_rot_approx_uniaxl)[0]] = p_half_bimodal_65_85_sigma_11_ntwrk_free_rot_approx_uniaxl
    nan_p_half_bimodal_50_100_sigma_11_ntwrk_free_rot_approx_uniaxl[:np.shape(p_half_bimodal_50_100_sigma_11_ntwrk_free_rot_approx_uniaxl)[0]] = p_half_bimodal_50_100_sigma_11_ntwrk_free_rot_approx_uniaxl
    nan_p_half_bimodal_25_125_sigma_11_ntwrk_free_rot_approx_uniaxl[:np.shape(p_half_bimodal_25_125_sigma_11_ntwrk_free_rot_approx_uniaxl)[0]] = p_half_bimodal_25_125_sigma_11_ntwrk_free_rot_approx_uniaxl
    nan_mono_75_75_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl[:np.shape(mono_75_75_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl)[0]] = mono_75_75_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl
    nan_p_half_bimodal_65_85_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl[:np.shape(p_half_bimodal_65_85_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl)[0]] = p_half_bimodal_65_85_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl
    nan_p_half_bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl[:np.shape(p_half_bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl)[0]] = p_half_bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl
    nan_p_half_bimodal_25_125_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl[:np.shape(p_half_bimodal_25_125_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl)[0]] = p_half_bimodal_25_125_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl

    lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response = np.column_stack(
        (lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response, nan_mono_75_75_sigma_11_ntwrk_free_rot_approx_uniaxl))
    lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response = np.column_stack(
        (lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response, nan_p_half_bimodal_65_85_sigma_11_ntwrk_free_rot_approx_uniaxl))
    lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response = np.column_stack(
        (lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response, nan_p_half_bimodal_50_100_sigma_11_ntwrk_free_rot_approx_uniaxl))
    lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response = np.column_stack(
        (lmbda_and_sigma_11_free_rot_approx_uniaxl_p_half_response, nan_p_half_bimodal_25_125_sigma_11_ntwrk_free_rot_approx_uniaxl))
    lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response = np.column_stack(
        (lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response, nan_mono_75_75_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl))
    lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response = np.column_stack(
        (lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response, nan_p_half_bimodal_65_85_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl))
    lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response = np.column_stack(
        (lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response, nan_p_half_bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl))
    lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response = np.column_stack(
        (lmbda_and_sigma_11_frame_avrg_approx_so3_quad_uniaxl_p_half_response, nan_p_half_bimodal_25_125_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl))
    ...
    for p_indx in range(np.shape(p)[0]):
        ...
        if p_indx == 0:
            ...
            bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl = np.concatenate(
                (bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl, np.full_like(bimodal_50_100_lmbda_aesthetic_end, np.nan)))
        lmbda_and_bimodal_50_100_sigma_11_free_rot_approx_response = np.column_stack(
            (lmbda_and_bimodal_50_100_sigma_11_free_rot_approx_response, bimodal_50_100_sigma_11_ntwrk_free_rot_approx_uniaxl))
        lmbda_and_bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response = np.column_stack(
            (lmbda_and_bimodal_50_100_sigma_11_frame_avrg_approx_so3_quad_response, bimodal_50_100_sigma_11_ntwrk_frame_avrg_approx_so3_quad_uniaxl))
