...
from src.helpers.clnk_frame_averaging import (
    ...
    y_clnk_norm_frame_avrg_so3_quad_eval,
...
def main(cfg: DictConfig) -> None:
    ...
    # Save the monomer length for each chain in the cross-link
    # structures
    b_clnks_filename = filename_prefix + "-b_clnks" + ".npy"
    np.save(b_clnks_filename, b_clnks)
    ...
    for protocol_indx in range(dfrmtn_protocol_num):
        ...
        for clnk_indx in range(clnks_num):
            ...
            for dfrmtn_step in range(np.shape(dfrmtn_arr)[0]):
                ...
                (y_clnk_frame_avrg_so3, y_clnk_norm_frame_avrg_so3, _,
                ...
                y_clnk_norm_frame_avrg_so3_quad = (
                    y_clnk_norm_frame_avrg_so3_quad_eval(
                        so3_quad, sph_quad_symmtry, y_clnk_norm_frame_avrg_so3)
                )
                ...
                y_clnks_norm_frame_avrg_so3_quad[protocol_indx][clnk_indx, dfrmtn_step] = (
                    y_clnk_norm_frame_avrg_so3_quad
                )
                ...
                (omega_clnk_free_rot, _, y_clnk_free_rot, y_clnk_norm_free_rot,
                 _, W_clnk_chns_free_rot, W_clnk_y_flucts_free_rot) = (
                ...
                y_clnks_norm_free_rot[protocol_indx][clnk_indx, dfrmtn_step] = (
