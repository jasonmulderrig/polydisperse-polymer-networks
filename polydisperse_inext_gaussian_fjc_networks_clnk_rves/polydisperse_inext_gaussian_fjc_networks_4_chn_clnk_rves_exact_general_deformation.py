...
from src.helpers.clnk_free_rotation_utils import clnk_free_rot_cnstrnd_mnmztn
from src.helpers.clnk_frame_averaging_utils import clnk_frame_avrg_cnstrnd_mnmztn
    ...
    for protocol_indx in range(len(dfrmtn_protocol)):
        ...
        for dfrmtn_step in range(num_dfrmtn_steps):
            ...
            for clnk_indx in range(clnks_num):
                ...
                (omega_clnk_free_rot, _, y_clnk_free_rot, y_clnk_norm_free_rot,
                 _, W_clnk_free_rot, _) = clnk_free_rot_cnstrnd_mnmztn(
                    eval_W_flucts, cnstrnd_mnmztn_scope, cnstrnd_mnmztn_method,
                    rng, F, n_clnk, b, X_clnk, vol_quad_clnk,
                ...
                (y_clnk_frame_avrg_so3, _, _, _, _,
                 y_clnk_norm_frame_avrg_so3_quad, _, W_clnk_frame_avrg_so3_quad) = (
...
##### This code corresponds to the 20250724D.yaml configuration file.
##### Make sure to set the deformation and topology configuration files
##### to 20250724D.yaml in the config.yaml file before running.
@hydra.main(
        version_base=None,
