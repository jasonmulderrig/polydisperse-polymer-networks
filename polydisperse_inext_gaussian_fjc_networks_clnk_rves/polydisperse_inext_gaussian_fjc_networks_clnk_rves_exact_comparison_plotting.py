...
def main(cfg: DictConfig) -> None:
    ...
    sample = 0
    k_4_clnks_filename_prefix = filename_str(label.workdir, "20250724", "F", sample)
    k_6_clnks_filename_prefix = filename_str(label.workdir, "20250724", "G", sample)
    ...
    for clnk_indx in range(k_4_clnks_num):
        ...
        for chn_indx in range(k_num):
            clnk_str += str(k_4_clnks_n_clnks[clnk_indx, chn_indx])
    ...
    for clnk_indx in range(k_6_clnks_num):
        clnk_str = "$\\{"
        for chn_indx in range(k_num):
            clnk_str += str(k_6_clnks_n_clnks[clnk_indx, chn_indx])
            if chn_indx < k_num-1: clnk_str += ","
        clnk_str += "\\}$"
    ...
    W_clnks_free_rot_uniaxl_half_n_clnks_plot_fig_filename = (
        filepath + "W_clnks_free_rot_uniaxl_half_n_clnks_plot" + ".png"
    )
    fig, ax = plt.subplots()
    handles = []
    plt_format_indx = 0
    ...
    ax.scatter(
        k_4_clnks_lmbda, k_4_clnks_W_clnks_free_rot_uniaxl[0]/4, s=markersize,
    ...
    color = clnk_color[plt_format_indx]
    ax.scatter(
        k_6_clnks_lmbda, k_6_clnks_W_clnks_free_rot_uniaxl[0]/6, s=markersize,
        marker=marker, linewidth=markerlinewidth, edgecolors=color,
        facecolors="None", clip_on=False)
    handles.append((marker, color))
    ax.legend(
        ...
        labelspacing=0, markerfirst=False, loc="upper center")
    ax.set_xlim([0.4, 2.0])
    ax.set_ylim([1.4, 2.6])
    ax.tick_params(
    ...
    ax.set_ylabel("$\\leftparen W_{c, \\{\\cdot\\}}^{FR}/k_BT\\rightparen /k$", fontsize=16)
    fig.tight_layout()
    ...
    W_clnks_frame_avrg_so3_quad_uniaxl_half_n_clnks_plot_fig_filename = (
        filepath + "W_clnks_frame_avrg_so3_quad_uniaxl_half_n_clnks_plot" + ".png"
    )
    fig, ax = plt.subplots()
    handles = []
    plt_format_indx = 0
    ...
    color = clnk_color[plt_format_indx]
    ax.scatter(
        k_4_clnks_lmbda, k_4_clnks_W_clnks_frame_avrg_so3_quad_uniaxl[0]/4, s=markersize,
        marker=marker, linewidth=markerlinewidth, edgecolors=color,
        facecolors="None", clip_on=False)
    handles.append((marker, color))
    plt_format_indx += 1
    ...
    color = clnk_color[plt_format_indx]
    ax.scatter(
        k_6_clnks_lmbda, k_6_clnks_W_clnks_frame_avrg_so3_quad_uniaxl[0]/6, s=markersize,
        marker=marker, linewidth=markerlinewidth, edgecolors=color,
        facecolors="None", clip_on=False)
    handles.append((marker, color))
    ax.legend(
    ...
    ax.set_yticklabels(["$1.4~~$", "$1.6$", "$1.8$", "$2$", "$2.2$", "$2.4$", "$2.6$"])
    ax.set_xlabel("$\\lambda$", fontsize=16)
    ax.set_ylabel("$\\leftparen W_{c, \\{\\cdot\\}}^{FA}/k_BT\\rightparen /k$", fontsize=16)
    fig.tight_layout()
    fig.savefig(W_clnks_frame_avrg_so3_quad_uniaxl_half_n_clnks_plot_fig_filename)
    plt.close()

    W_clnks_free_rot_uniaxl_one_unique_n_clnks_plot_fig_filename = (
        filepath + "W_clnks_free_rot_uniaxl_one_unique_n_clnks_plot" + ".png"
    )
    fig, ax = plt.subplots()
    handles = []
    plt_format_indx = 0
    ...
    color = clnk_color[plt_format_indx]
    ax.scatter(
        k_4_clnks_lmbda, k_4_clnks_W_clnks_free_rot_uniaxl[1]/4, s=markersize,
        marker=marker, linewidth=markerlinewidth, edgecolors=color,
        facecolors="None", clip_on=False)
    handles.append((marker, color))
    plt_format_indx += 1
    ...
    color = clnk_color[plt_format_indx]
    ax.scatter(
        k_6_clnks_lmbda, k_6_clnks_W_clnks_free_rot_uniaxl[1]/6, s=markersize,
        marker=marker, linewidth=markerlinewidth, edgecolors=color,
        facecolors="None", clip_on=False)
    handles.append((marker, color))
    ax.legend(
    ...
    W_clnks_frame_avrg_so3_quad_uniaxl_one_unique_n_clnks_plot_fig_filename = (
        filepath + "W_clnks_frame_avrg_so3_quad_uniaxl_one_unique_n_clnks_plot" + ".png"
    )
    fig, ax = plt.subplots()
    handles = []
    plt_format_indx = 0
    ...
    color = clnk_color[plt_format_indx]
    ax.scatter(
        k_4_clnks_lmbda, k_4_clnks_W_clnks_frame_avrg_so3_quad_uniaxl[1]/4, s=markersize,
        marker=marker, linewidth=markerlinewidth, edgecolors=color,
        facecolors="None", clip_on=False)
    handles.append((marker, color))
    plt_format_indx += 1
    ...
    color = clnk_color[plt_format_indx]
    ax.scatter(
        k_6_clnks_lmbda, k_6_clnks_W_clnks_frame_avrg_so3_quad_uniaxl[1]/6, s=markersize,
        marker=marker, linewidth=markerlinewidth, edgecolors=color,
        facecolors="None", clip_on=False)
    handles.append((marker, color))
    ax.legend(
    ...
    ax.set_ylabel("$\\leftparen W_{c, \\{\\cdot\\}}^{FA}/k_BT\\rightparen /k$", fontsize=16)
    fig.tight_layout()
    fig.savefig(W_clnks_frame_avrg_so3_quad_uniaxl_one_unique_n_clnks_plot_fig_filename)
    plt.close()
