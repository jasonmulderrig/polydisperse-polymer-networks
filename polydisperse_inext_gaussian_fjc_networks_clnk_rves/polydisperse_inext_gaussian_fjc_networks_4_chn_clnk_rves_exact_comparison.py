        ...
        for dfrmtn_step in range(num_dfrmtn_steps):
            ...
            for clnk_indx in range(clnks_num):
                ...
                (omega_clnk_free_rot, _, y_clnk_free_rot, _, _, W_clnk_free_rot,
                 _) = clnk_free_rot_cnstrnd_mnmztn(
                ...
                (y_clnk_frame_avrg_so3, _, _, _, _, _, _,
                 W_clnk_frame_avrg_so3_quad) = clnk_frame_avrg_cnstrnd_mnmztn(
                    cnstrnd_mnmztn_scope, cnstrnd_mnmztn_method, rng, F, n_clnk,
                    b, X_clnk, so3_quad, sph_quad_symmtry,
...
##### This code corresponds to the 20250724F.yaml configuration file.
##### Make sure to set the deformation and topology configuration files
##### to 20250724F.yaml in the config.yaml file before running.
@hydra.main(
        version_base=None,
