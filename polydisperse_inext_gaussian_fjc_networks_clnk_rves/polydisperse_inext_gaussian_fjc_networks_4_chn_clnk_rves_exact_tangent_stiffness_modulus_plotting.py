...
def main(cfg: DictConfig) -> None:
    ...
    sample = 0
    filename_prefix = filename_str(label.workdir, "20250724", "E", sample)
    ...
    for chn_indx in range(k_num):
        clnk_str += str(n_clnks[0, chn_indx])
    ...
    W_clnks_free_rot_uniaxl_13_rves_plot_fig_filename = (
        filepath + "W_clnks_free_rot_uniaxl_13_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    plt_format_indx = 0
    ax.plot(
    ...
    W_clnks_frame_avrg_so3_quad_uniaxl_13_rves_plot_fig_filename = (
        filepath + "W_clnks_frame_avrg_so3_quad_uniaxl_13_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    plt_format_indx = 0
    ax.plot(
    ...
    W_clnks_free_rot_uniaxl_22_rves_plot_fig_filename = (
        filepath + "W_clnks_free_rot_uniaxl_22_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    plt_format_indx = 0
    ax.plot(
    ...
    W_clnks_frame_avrg_so3_quad_uniaxl_22_rves_plot_fig_filename = (
        filepath + "W_clnks_frame_avrg_so3_quad_uniaxl_22_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    plt_format_indx = 0
    ax.plot(
    ...
    E_clnks_free_rot_uniaxl_13_rves_plot_fig_filename = (
        filepath + "E_clnks_free_rot_uniaxl_13_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    plt_format_indx = 0
    ax.plot(
    ...
    ax.set_xlabel("$\\lambda$", fontsize=16)
    ax.set_ylabel("$E_{\\{\\cdot\\}}^{FR}/k_BT$", fontsize=16)
    fig.tight_layout()
    ...
    E_clnks_frame_avrg_so3_quad_uniaxl_13_rves_plot_fig_filename = (
        filepath + "E_clnks_frame_avrg_so3_quad_uniaxl_13_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    plt_format_indx = 0
    ax.plot(
    ...
    ax.set_xlabel("$\\lambda$", fontsize=16)
    ax.set_ylabel("$E_{\\{\\cdot\\}}^{FA}/k_BT$", fontsize=16)
    fig.tight_layout()
    fig.savefig(E_clnks_frame_avrg_so3_quad_uniaxl_13_rves_plot_fig_filename)
    plt.close()

    E_clnks_free_rot_uniaxl_22_rves_plot_fig_filename = (
        filepath + "E_clnks_free_rot_uniaxl_22_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    plt_format_indx = 0
    ax.plot(
    ...
    E_clnks_frame_avrg_so3_quad_uniaxl_22_rves_plot_fig_filename = (
        filepath + "E_clnks_frame_avrg_so3_quad_uniaxl_22_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    plt_format_indx = 0
    ax.plot(
