...
##### This code corresponds to the 20251204G.yaml configuration file.
##### Make sure to set the deformation and topology configuration files
##### to 20251204G.yaml in the config.yaml file before running.
@hydra.main(
        version_base=None,
    ...
    for protocol_indx in range(len(dfrmtn_protocol)):
        ...
        for dfrmtn_step in range(num_dfrmtn_steps):
            ...
            for clnk_indx in range(clnks_num):
                ...
                (omega_clnk_free_rot, _, y_clnk_free_rot, _, _, _, _,
                ...
                (y_clnk_frame_avrg_so3, _, _, _, _, _, _, _, _, _, _,
