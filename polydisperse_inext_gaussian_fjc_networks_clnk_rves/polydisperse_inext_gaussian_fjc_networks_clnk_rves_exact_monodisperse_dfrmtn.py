...
def main(cfg: DictConfig) -> None:
    ...
    for protocol_indx in range(dfrmtn_protocol_num):
        ...
        for clnk_indx in range(clnks_num):
            ...
            w_c_dist_clnk = w_c_dist_clnks[clnk_indx]
            ...
            for dfrmtn_step in range(np.shape(dfrmtn_arr)[0]):
                ...
                # structures
                (_, _, _, W_clnk_chns_star_frame_avrg_so3,
                 W_clnk_y_flucts_star_frame_avrg_so3) = (
                    monodisperse_clnk_frame_avrg(
                        cfg.deformation.eval_W_clnk_y_flucts, F, so3_quad,
                        n_clnk, b_clnk, X_clnk, y_clnk_init,
                        w_c_dist_clnk, w_c_func_clnk, w_c_args_clnk,
                        d2w_c__dy_clnk_dy_clnk_func_clnk,
                        d2w_c__dy_clnk_dy_clnk_args_clnk,
