...
def main(cfg: DictConfig) -> None:
    ...
    sample = 0
    filename_prefix = filename_str(label.workdir, "20250724", "H", sample)
    ...
    W_clnks_model_comparison_uniaxl_13_rves_plot_fig_filename = (
        filepath + "W_clnks_model_comparison_uniaxl_13_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    ax.plot(
    ...
    ax.set_ylabel("$W_{c, \\{\\cdot\\}}/k_BT$", fontsize=16)
    fig.tight_layout()
    ...
    W_clnks_model_comparison_uniaxl_22_rves_plot_fig_filename = (
        filepath + "W_clnks_model_comparison_uniaxl_22_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    ax.plot(
    ...
    E_clnks_model_comparison_uniaxl_13_rves_plot_fig_filename = (
        filepath + "E_clnks_model_comparison_uniaxl_13_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    ax.plot(
    ...
    ax.set_xlabel("$\\lambda$", fontsize=16)
    ax.set_ylabel("$E_{\\{\\cdot\\}}/k_BT$", fontsize=16)
    fig.tight_layout()
    ...
    E_clnks_model_comparison_uniaxl_22_rves_plot_fig_filename = (
        filepath + "E_clnks_model_comparison_uniaxl_22_rves_plot" + ".png"
    )
    fig, ax = plt.subplots()
    ax.plot(
