...
def main(cfg: DictConfig) -> None:
    ...
    W_clnks_free_rot_uniaxl_agreement_plot_fig_filename = (
        filepath + "W_clnks_free_rot_uniaxl_agreement_plot" + ".png"
    )
    fig, ax = plt.subplots()
    handles = []
    for clnk_indx in range(clnks_num):
    ...
    W_clnks_frame_avrg_so3_quad_uniaxl_agreement_plot_fig_filename = (
        filepath + "W_clnks_frame_avrg_so3_quad_uniaxl_agreement_plot" + ".png"
    )
    fig, ax = plt.subplots()
    handles = []
    for clnk_indx in range(clnks_num):
    ...
    W_clnks_free_rot_simple_shear_agreement_plot_fig_filename = (
        filepath + "W_clnks_free_rot_simple_shear_agreement_plot" + ".png"
    )
    fig, ax = plt.subplots()
    handles = []
    for clnk_indx in range(clnks_num):
    ...
    W_clnks_frame_avrg_so3_quad_simple_shear_agreement_plot_fig_filename = (
        filepath + "W_clnks_frame_avrg_so3_quad_simple_shear_agreement_plot" + ".png"
    )
    fig, ax = plt.subplots()
    handles = []
    for clnk_indx in range(clnks_num):
    ...
    ax.set_ylabel("$W_{c, \\{\\cdot\\}}^{FA}/k_BT$", fontsize=16)
    fig.tight_layout()
    fig.savefig(W_clnks_frame_avrg_so3_quad_simple_shear_agreement_plot_fig_filename)
    plt.close()
