...
from src.helpers.clnk_frame_averaging import monodisperse_clnk_frame_avrg

##### This code corresponds to the 20260203B.yaml, 20260203C.yaml, and
##### 20260203D.yaml configuration files. Make sure to set the
##### deformation and topology configuration files to 20260203B.yaml,
##### 20260203C.yaml, and 20260203D.yaml in the config.yaml file before
##### running.
@hydra.main(
        version_base=None,
...
def main(cfg: DictConfig) -> None:
    ...
    # nondimensional polymer chain deformation free energy function, and
    ...
    for protocol_indx in range(len(dfrmtn_protocol)):
        ...
        for dfrmtn_step in range(num_dfrmtn_steps):
            ...
            max_gamma_clnks_frame_avrg_approx_so3 = np.max(
                gamma_clnks_frame_avrg_approx_so3[protocol_indx][dfrmtn_step])
            print("{}, {}={}, max_gamma_clnks_frame_avrg_approx_so3={}".format(dfrmtn_protocol_class_str, dfrmtn_str, dfrmtn_arr[dfrmtn_step], max_gamma_clnks_frame_avrg_approx_so3))
